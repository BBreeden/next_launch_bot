...
class Launch:
    def __init__(self):
        ...
        self.launch_dt_obj = get_timedate_obj(data['net'])
...
'''
Returns a DateTime object of the NET.
args:
    date_string - the time and date information in the form of a string
return:
    DateTime object conversion of the string.
'''
def get_timedate_obj(date_string):
